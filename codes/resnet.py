...
model_urls = {
    ...
    'resnet18_local': './pretrained_model/resnet18-f37072fd.pth'
...
class ResNet(nn.Module):
    ...
    def _forward_impl(self, xx: Tensor) -> Tensor:
...
def _resnet(
    ...
    **kwargs: Any,
    ...
    if pretrained:
        ...
        state_dict = torch.load(model_urls['resnet18_local'])
...
def resnet18(cfg, pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
    ...
    """
    return _resnet(cfg, "resnet18", BasicBlock, [2, 2, 2, 2], pretrained, progress, **kwargs)
